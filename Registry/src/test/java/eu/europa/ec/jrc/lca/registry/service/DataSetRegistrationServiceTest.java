...
public class DataSetRegistrationServiceTest {
    ...
    @Test
    public void t1_testRegisterDataSet() throws NodeIllegalStatusException {
    ...
    @Test
    public void t2_testRegisterDataSets() throws NodeIllegalStatusException {
    ...
    @Test
    public void t3_testRegisterDataSets2() throws NodeIllegalStatusException {
        List<DataSet> dss = new ArrayList<DataSet>();
        dss.add(createDS("UUID2", "complianceUUID1"));
        dss.add(createDS("UUID3", "complianceUUID1"));
        List<DataSetRegistrationResult> registered = dataSetRegistrationService.registerDataSets(dss, "testNodeId2");
    ...
    @Test
    public void t4_testRegisterDataSets3() throws NodeIllegalStatusException {
        List<DataSet> dss = new ArrayList<DataSet>();
    ...
    public void t5_testRegisterDataSetInNotApprovedNode() throws NodeIllegalStatusException {
