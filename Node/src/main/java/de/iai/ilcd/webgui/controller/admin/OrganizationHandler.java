...
public class OrganizationHandler extends AbstractAdminEntryHandler<Organization> {
     ...
     *
     * @param userAccessBean user access bean to set
     */
    ...
    protected void postEntrySet() {
        ...
        Collections.sort(orgGroup,
                (g1, g2) -> g1.getDisplayName().toLowerCase(Locale.ROOT)
                        .compareTo(g2.getDisplayName().toLowerCase(Locale.ROOT))); // Anonymous Comparator<User>
     ...
     * @param userAssignment  dual list with assigned users
     * @param groupAssignment dual list with assigned groups
     ...
     *
     * @param dualGroupAssignmentList dual list to set
     */
     ...
     *
     * @param dualUserAssignmentList dual list to set
     */
     ...
     *
     * @param event JSF transfer event
     */
