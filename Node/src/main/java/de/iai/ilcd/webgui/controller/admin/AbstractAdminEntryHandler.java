...
public abstract class AbstractAdminEntryHandler<T extends ILongIdObject> extends AbstractHandler {
     ...
     */
    @ManagedProperty("#{url}")
    protected URLGeneratorBean urlGenerator;
    /**
     * Selected items
     */
    private T entry;
     ...
     *
     * @param entryIdString id as string to set
     */
     ...
     * @throws Exception if no entry found or errors occurred
     */
     ...
     * @return <code>true</code> on success, <code>false</code> otherwise
     */
    protected boolean saveEntryInternal() {
     ...
     *
     * @param urlGenerator generator to set
     */
