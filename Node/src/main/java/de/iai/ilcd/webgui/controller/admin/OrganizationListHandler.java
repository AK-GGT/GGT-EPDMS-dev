...
public class OrganizationListHandler extends AbstractAdminListHandler<Organization> {
     ...
     * </p>
     *
     * @param selected selected organizations
     */
     ...
     */
    @Override
    public List<Organization> lazyLoad(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, Object> filters) {
