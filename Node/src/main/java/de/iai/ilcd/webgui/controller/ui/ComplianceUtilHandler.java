...
public class ComplianceUtilHandler {
     ...
     *
     * @param collComplianceSystems list of compliance systems
     ...
     * Get the highest priority compliance system code for the provided collection
     *
     * @param uuids the list of uuids to check. they will be considered to be fully compliant for overall compliance
     * @return highest priority compliance system code
     */
     ...
     * an {@link ArrayList})
     *
     * @param p the object that declares compliance
     ...
     *
     * @param uuid    UUID (string representation) to check
