...
public class StockURLGenerator extends AbstractURLGenerator {
     ...
     *
     * @param urlBean the URL generator bean
     * @param isRoot  <code>true</code> if stock is root stock, else <code>false</code>
     */
     ...
     * Get the URL to edit stock
     *
     * @param uid       ID of the stock to edit
     * @param stockName name of the stock
     * @return generated URL
     */
    public String getEdit(Long uid, String stockName) {
        return getEdit(uid, stockName, null);
    }

    public String getEdit(Long uid, String stockName, Integer activeTabIndex) {
        StringBuilder sb = new StringBuilder("/admin/stocks/editStock.xhtml?");
        sb.append(uid != null ? "stockId=" + String.valueOf(uid) + "&" : "");
        sb.append("&activeTabIndex=" + (activeTabIndex == null ? String.valueOf(0) : activeTabIndex) + "&");
        sb.append(super.getStockURLParam(stockName));
        return sb.toString();
    }

    public String getEdit(Long uid, Integer activeTabIndex) {
        return getEdit(uid, this.getCurrentStockName(), activeTabIndex);
    }
