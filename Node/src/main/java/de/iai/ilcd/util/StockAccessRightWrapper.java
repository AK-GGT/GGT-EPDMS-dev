...
public class StockAccessRightWrapper {
     ...
     * Wrapper for delete
     */
    private final StockAccessRightBooleanPropertyWrapper tag;
     ...
     * Create wrapper
     *
     * @param accessRight stock access right instance to wrap
     */
    public StockAccessRightWrapper(StockAccessRight accessRight, ISecurityEntity subject) {
        ...
        this.tag = new StockAccessRightBooleanPropertyWrapper(ProtectionType.TAG);
    ...
    public StockAccessRightBooleanPropertyWrapper getTag() {
        return tag;
    }
