...
public class DataStockListAdapter extends DataStockList {
     ...
     * Create the adapter
     *
     * @param datastocks the data stocks to adapt
     */
    ...
    public static DataStockVO getServiceApiVo(AbstractDataStock ads) {
        ...
        LStringAdapter.copyLStrings(ads.getLongTitle(), vo.getName(), null);
        LStringAdapter.copyLStrings(ads.getDescription(), vo.getDescription(), null);
        return vo;
    }
