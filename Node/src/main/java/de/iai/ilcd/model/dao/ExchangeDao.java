...
public class ExchangeDao {
     ...
     *
     * @param processUuid
     * @param v           specific version of process data set. may be <code>null</code> (means: mostRecentVersion)
     * @param exDir       exchange direction (may be <code>null</code>, means: no constraint, both directions in result)
     * @param flowType    type of the flow (may be <code>null</code>, means: all types will be returned)
     * @return list of exchanges matching the criteria
     */
    @SuppressWarnings("unchecked")
    public List<Exchange> getExchangesForProcess(String processUuid, DataSetVersion v, ExchangeDirectionValues exDir, TypeOfFlowValue flowType) {
